...
type ContentServiceClient interface {
	...
	AddMetadata(ctx context.Context, in *Metadata, opts ...grpc.CallOption) (*SignedUrl, error)
...
func (c *contentServiceClient) AddMetadata(ctx context.Context, in *Metadata, opts ...grpc.CallOption) (*SignedUrl, error) {
	out := new(SignedUrl)
...
type ContentServiceServer interface {
	...
	AddMetadata(context.Context, *Metadata) (*SignedUrl, error)
...
func (UnimplementedContentServiceServer) AddMetadata(context.Context, *Metadata) (*SignedUrl, error) {
...
func _ContentService_AddMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ContentServiceServer).AddMetadata(ctx, req.(*Metadata))
	}
	return interceptor(ctx, in, info, handler)
}
