...
func NewManager(permissionsClient *authzed.Client) *Manager {
	return &Manager{
		permissionsClient: permissionsClient,
	}
}

func (s *Manager) CheckWithError(ctx context.Context, objectType ObjectType, resourceId string, action grpc.PermissionAction) error {
...
func (s *Manager) CheckWithUserIdError(ctx context.Context, userId string, objectType ObjectType, resourceId string, action grpc.PermissionAction) error {
...
func (s *Manager) getObjectType(objectType ObjectType) string {
	switch objectType {
	case MetadataObject:
		return "metadata"
...
func (s *Manager) getSubjectType(group bool) string {
	if group {
		return "group"
	} else {
		return "user"
...
func (s *Manager) getRelation(relation grpc.PermissionRelation) string {
	switch relation {
...
func (s *Manager) getAction(relation grpc.PermissionAction) string {
	switch relation {
...
func (s *Manager) CreateRelationship(ctx context.Context, objectType ObjectType, permission *grpc.Permission) error {
...
func (s *Manager) GetPermissions(ctx context.Context, objectType ObjectType, resourceId string) (*grpc.Permissions, error) {
