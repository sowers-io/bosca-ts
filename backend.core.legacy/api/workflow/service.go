...
type service struct {
	...
	queueClient   grpc.WorkflowQueueServiceClient
}

func NewService(cfg *configuration.ServerConfiguration, dataStore *DataStore, serviceAccountId, serviceAccountToken string, objectStore objectstore.ObjectStore, permissions security.PermissionManager, contentClient content.ContentServiceClient, queueClient grpc.WorkflowQueueServiceClient) grpc.WorkflowServiceServer {
