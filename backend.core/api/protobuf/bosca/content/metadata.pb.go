...
var file_bosca_content_metadata_proto_rawDesc = []byte{
	...
	0x64, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x64, 0x42, 0x1f, 0x5a, 0x1d, 0x62, 0x6f, 0x73, 0x63, 0x61,
...
var file_bosca_content_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_bosca_content_metadata_proto_goTypes = []interface{}{
...
func file_bosca_content_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_bosca_content_metadata_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_bosca_content_metadata_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
