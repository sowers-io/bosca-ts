...
type ProfilesServiceClient interface {
	GetConfiguration(ctx context.Context, in *bosca.Empty, opts ...grpc.CallOption) (*ProfileConfiguration, error)
	GetMyProfile(ctx context.Context, in *bosca.Empty, opts ...grpc.CallOption) (*Profile, error)
	GetProfileAttributeTypes(ctx context.Context, in *bosca.IdsRequest, opts ...grpc.CallOption) (*ProfileAttributeTypes, error)
}
...
func (c *profilesServiceClient) GetConfiguration(ctx context.Context, in *bosca.Empty, opts ...grpc.CallOption) (*ProfileConfiguration, error) {
...
func (c *profilesServiceClient) GetMyProfile(ctx context.Context, in *bosca.Empty, opts ...grpc.CallOption) (*Profile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Profile)
...
func (c *profilesServiceClient) GetProfileAttributeTypes(ctx context.Context, in *bosca.IdsRequest, opts ...grpc.CallOption) (*ProfileAttributeTypes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProfilesServiceServer interface {
	GetConfiguration(context.Context, *bosca.Empty) (*ProfileConfiguration, error)
	GetMyProfile(context.Context, *bosca.Empty) (*Profile, error)
	GetProfileAttributeTypes(context.Context, *bosca.IdsRequest) (*ProfileAttributeTypes, error)
...
func (UnimplementedProfilesServiceServer) GetConfiguration(context.Context, *bosca.Empty) (*ProfileConfiguration, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetConfiguration not implemented")
}
func (UnimplementedProfilesServiceServer) GetMyProfile(context.Context, *bosca.Empty) (*Profile, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMyProfile not implemented")
}
func (UnimplementedProfilesServiceServer) GetProfileAttributeTypes(context.Context, *bosca.IdsRequest) (*ProfileAttributeTypes, error) {
...
func _ProfilesService_GetConfiguration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfilesServiceServer).GetConfiguration(ctx, req.(*bosca.Empty))
	}
...
func _ProfilesService_GetMyProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfilesServiceServer).GetMyProfile(ctx, req.(*bosca.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ProfilesService_GetProfileAttributeTypes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfilesServiceServer).GetProfileAttributeTypes(ctx, req.(*bosca.IdsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProfilesService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "bosca/profiles/profiles.proto",
}
