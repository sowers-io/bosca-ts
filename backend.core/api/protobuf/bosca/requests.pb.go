...
var file_bosca_requests_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x62, 0x6f, 0x73, 0x63, 0x61, 0x22, 0x1b, 0x0a,
	...
	0x17, 0x5a, 0x15, 0x62, 0x6f, 0x73, 0x63, 0x61, 0x2e, 0x69, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f,
...
var file_bosca_requests_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_bosca_requests_proto_goTypes = []interface{}{
...
func file_bosca_requests_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_bosca_requests_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bosca_requests_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bosca_requests_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Url); i {
			case 0:
				return &v.state
			case 1:
		...
		file_bosca_requests_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
