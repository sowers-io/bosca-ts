...
var file_bosca_workflow_service_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0xcc, 0x10, 0x0a, 0x0f, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x53, 0x65,
	...
	0x9e, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x41,
	0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x4a, 0x6f, 0x62, 0x73, 0x12, 0x2a, 0x2e, 0x62, 0x6f,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x23, 0x2e, 0x62, 0x6f, 0x73, 0x63, 0x61, 0x2e,
	0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f,
	0x77, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x4a, 0x6f, 0x62, 0x22, 0x30, 0x82, 0xd3,
	0xe4, 0x93, 0x02, 0x2a, 0x3a, 0x01, 0x2a, 0x22, 0x25, 0x2f, 0x76, 0x31, 0x2f, 0x77, 0x6f, 0x72,
	0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x71, 0x75, 0x65, 0x75, 0x65, 0x2f, 0x7b, 0x71, 0x75, 0x65,
	0x75, 0x65, 0x7d, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x69, 0x65, 0x73, 0x30, 0x01,
...
var file_bosca_workflow_service_proto_goTypes = []any{
	...
	(*WorkflowActivityJobRequest)(nil),        // 5: bosca.workflow.WorkflowActivityJobRequest
	(*Models)(nil),                            // 6: bosca.workflow.Models
	(*Model)(nil),                             // 7: bosca.workflow.Model
	(*Prompts)(nil),                           // 8: bosca.workflow.Prompts
	(*Prompt)(nil),                            // 9: bosca.workflow.Prompt
	(*StorageSystems)(nil),                    // 10: bosca.workflow.StorageSystems
	(*StorageSystem)(nil),                     // 11: bosca.workflow.StorageSystem
	(*StorageSystemModels)(nil),               // 12: bosca.workflow.StorageSystemModels
	(*Workflows)(nil),                         // 13: bosca.workflow.Workflows
	(*Workflow)(nil),                          // 14: bosca.workflow.Workflow
	(*WorkflowState)(nil),                     // 15: bosca.workflow.WorkflowState
	(*WorkflowStates)(nil),                    // 16: bosca.workflow.WorkflowStates
	(*WorkflowActivities)(nil),                // 17: bosca.workflow.WorkflowActivities
	(*WorkflowActivityStorageSystems)(nil),    // 18: bosca.workflow.WorkflowActivityStorageSystems
	(*WorkflowActivityPrompts)(nil),           // 19: bosca.workflow.WorkflowActivityPrompts
	(*WorkflowActivityJob)(nil),               // 20: bosca.workflow.WorkflowActivityJob
}
var file_bosca_workflow_service_proto_depIdxs = []int32{
	...
	5,  // 16: bosca.workflow.WorkflowService.GetWorkflowActivityJobs:input_type -> bosca.workflow.WorkflowActivityJobRequest
	6,  // 17: bosca.workflow.WorkflowService.GetModels:output_type -> bosca.workflow.Models
	7,  // 18: bosca.workflow.WorkflowService.GetModel:output_type -> bosca.workflow.Model
	8,  // 19: bosca.workflow.WorkflowService.GetPrompts:output_type -> bosca.workflow.Prompts
	9,  // 20: bosca.workflow.WorkflowService.GetPrompt:output_type -> bosca.workflow.Prompt
	10, // 21: bosca.workflow.WorkflowService.GetStorageSystems:output_type -> bosca.workflow.StorageSystems
	11, // 22: bosca.workflow.WorkflowService.GetStorageSystem:output_type -> bosca.workflow.StorageSystem
	12, // 23: bosca.workflow.WorkflowService.GetStorageSystemModels:output_type -> bosca.workflow.StorageSystemModels
	13, // 24: bosca.workflow.WorkflowService.GetWorkflows:output_type -> bosca.workflow.Workflows
	14, // 25: bosca.workflow.WorkflowService.GetWorkflow:output_type -> bosca.workflow.Workflow
	15, // 26: bosca.workflow.WorkflowService.GetWorkflowState:output_type -> bosca.workflow.WorkflowState
	16, // 27: bosca.workflow.WorkflowService.GetWorkflowStates:output_type -> bosca.workflow.WorkflowStates
	17, // 28: bosca.workflow.WorkflowService.GetWorkflowActivities:output_type -> bosca.workflow.WorkflowActivities
	18, // 29: bosca.workflow.WorkflowService.GetWorkflowActivityStorageSystems:output_type -> bosca.workflow.WorkflowActivityStorageSystems
	19, // 30: bosca.workflow.WorkflowService.GetWorkflowActivityPrompts:output_type -> bosca.workflow.WorkflowActivityPrompts
	0,  // 31: bosca.workflow.WorkflowService.BeginTransitionWorkflow:output_type -> bosca.Empty
	0,  // 32: bosca.workflow.WorkflowService.CompleteTransitionWorkflow:output_type -> bosca.Empty
	20, // 33: bosca.workflow.WorkflowService.GetWorkflowActivityJobs:output_type -> bosca.workflow.WorkflowActivityJob
