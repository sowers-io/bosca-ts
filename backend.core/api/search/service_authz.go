...
type authorizationService struct {
	...
	service     grpc.SearchServiceServer
	permissions security.PermissionManager
}

func NewAuthorizationService(permissions security.PermissionManager, service grpc.SearchServiceServer) grpc.SearchServiceServer {
...
func (svc *authorizationService) Search(ctx context.Context, request *grpc.SearchRequest) (*grpc.SearchResponse, error) {
	return svc.service.Search(ctx, request)
}
