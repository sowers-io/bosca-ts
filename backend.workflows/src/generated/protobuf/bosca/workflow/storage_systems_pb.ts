...
// @generated from file bosca/workflow/storage_systems.proto (package bosca.workflow, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum bosca.workflow.StorageSystemType
 */
...
proto3.util.setEnumType(StorageSystemType, "bosca.workflow.StorageSystemType", [
...
/**
 * @generated from message bosca.workflow.StorageSystem
 */
export class StorageSystem extends Message<StorageSystem> {
  ...
  /**
   * @generated from field: bosca.workflow.StorageSystemType type = 2;
   */
  ...
  static readonly typeName = "bosca.workflow.StorageSystem";
...
/**
 * @generated from message bosca.workflow.StorageSystems
 */
export class StorageSystems extends Message<StorageSystems> {
  /**
   * @generated from field: repeated bosca.workflow.StorageSystem systems = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bosca.workflow.StorageSystems";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message bosca.workflow.StorageSystemModel
 */
export class StorageSystemModel extends Message<StorageSystemModel> {
  /**
   * @generated from field: bosca.workflow.Model model = 2;
   */
  model?: Model;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bosca.workflow.StorageSystemModel";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message bosca.workflow.StorageSystemModels
 */
export class StorageSystemModels extends Message<StorageSystemModels> {
  /**
   * @generated from field: repeated bosca.workflow.StorageSystemModel models = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bosca.workflow.StorageSystemModels";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
