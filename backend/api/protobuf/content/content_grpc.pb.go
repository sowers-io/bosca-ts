...
func (c *contentServiceClient) GetWorkflowById(ctx context.Context, in *protobuf.IdRequest, opts ...grpc.CallOption) (*Workflow, error) {
	...
	out := new(Workflow)
	err := c.cc.Invoke(ctx, ContentService_GetWorkflowById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contentServiceClient) GetWorkflowStateById(ctx context.Context, in *protobuf.IdRequest, opts ...grpc.CallOption) (*WorkflowState, error) {
	...
	err := c.cc.Invoke(ctx, ContentService_GetWorkflowStateById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contentServiceClient) GetTraitById(ctx context.Context, in *protobuf.IdRequest, opts ...grpc.CallOption) (*Trait, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Trait)
	err := c.cc.Invoke(ctx, ContentService_GetTraitById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
