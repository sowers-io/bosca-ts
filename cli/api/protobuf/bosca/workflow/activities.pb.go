...
var file_bosca_workflow_activities_proto_rawDesc = []byte{
	...
	,
...
var file_bosca_workflow_activities_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_bosca_workflow_activities_proto_goTypes = []any{
	...
	(*WorkflowActivityIdIntRequest)(nil),   // 10: bosca.workflow.WorkflowActivityIdIntRequest
	nil,                                    // 11: bosca.workflow.Activity.ConfigurationEntry
	nil,                                    // 12: bosca.workflow.Activity.InputsEntry
	nil,                                    // 13: bosca.workflow.Activity.OutputsEntry
	nil,                                    // 14: bosca.workflow.WorkflowActivityPrompt.ConfigurationEntry
	nil,                                    // 15: bosca.workflow.WorkflowActivityStorageSystem.ConfigurationEntry
	nil,                                    // 16: bosca.workflow.WorkflowActivityModel.ConfigurationEntry
	nil,                                    // 17: bosca.workflow.WorkflowActivity.ConfigurationEntry
	nil,                                    // 18: bosca.workflow.WorkflowActivity.InputsEntry
	nil,                                    // 19: bosca.workflow.WorkflowActivity.OutputsEntry
	(*Prompt)(nil),                         // 20: bosca.workflow.Prompt
	(*StorageSystem)(nil),                  // 21: bosca.workflow.StorageSystem
	(*StorageSystemModel)(nil),             // 22: bosca.workflow.StorageSystemModel
	(*Model)(nil),                          // 23: bosca.workflow.Model
}
var file_bosca_workflow_activities_proto_depIdxs = []int32{
	11, // 0: bosca.workflow.Activity.configuration:type_name -> bosca.workflow.Activity.ConfigurationEntry
	12, // 1: bosca.workflow.Activity.inputs:type_name -> bosca.workflow.Activity.InputsEntry
	13, // 2: bosca.workflow.Activity.outputs:type_name -> bosca.workflow.Activity.OutputsEntry
	20, // 3: bosca.workflow.WorkflowActivityPrompt.prompt:type_name -> bosca.workflow.Prompt
	14, // 4: bosca.workflow.WorkflowActivityPrompt.configuration:type_name -> bosca.workflow.WorkflowActivityPrompt.ConfigurationEntry
	2,  // 5: bosca.workflow.WorkflowActivityPrompts.prompts:type_name -> bosca.workflow.WorkflowActivityPrompt
	21, // 6: bosca.workflow.WorkflowActivityStorageSystem.storage_system:type_name -> bosca.workflow.StorageSystem
	22, // 7: bosca.workflow.WorkflowActivityStorageSystem.models:type_name -> bosca.workflow.StorageSystemModel
	15, // 8: bosca.workflow.WorkflowActivityStorageSystem.configuration:type_name -> bosca.workflow.WorkflowActivityStorageSystem.ConfigurationEntry
	4,  // 9: bosca.workflow.WorkflowActivityStorageSystems.systems:type_name -> bosca.workflow.WorkflowActivityStorageSystem
	23, // 10: bosca.workflow.WorkflowActivityModel.model:type_name -> bosca.workflow.Model
	16, // 11: bosca.workflow.WorkflowActivityModel.configuration:type_name -> bosca.workflow.WorkflowActivityModel.ConfigurationEntry
	17, // 12: bosca.workflow.WorkflowActivity.configuration:type_name -> bosca.workflow.WorkflowActivity.ConfigurationEntry
	18, // 13: bosca.workflow.WorkflowActivity.inputs:type_name -> bosca.workflow.WorkflowActivity.InputsEntry
	19, // 14: bosca.workflow.WorkflowActivity.outputs:type_name -> bosca.workflow.WorkflowActivity.OutputsEntry
