...
type WorkflowServiceClient interface {
	...
	ExecuteWorkflow(ctx context.Context, in *WorkflowExecutionRequest, opts ...grpc.CallOption) (*WorkflowEnqueueResponse, error)
	FindAndExecuteWorkflow(ctx context.Context, in *FindAndWorkflowExecutionRequest, opts ...grpc.CallOption) (*WorkflowEnqueueResponses, error)
}
...
func (c *workflowServiceClient) GetWorkflowActivityPrompts(ctx context.Context, in *WorkflowActivityIdIntRequest, opts ...grpc.CallOption) (*WorkflowActivityPrompts, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *workflowServiceClient) ExecuteWorkflow(ctx context.Context, in *WorkflowExecutionRequest, opts ...grpc.CallOption) (*WorkflowEnqueueResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *workflowServiceClient) FindAndExecuteWorkflow(ctx context.Context, in *FindAndWorkflowExecutionRequest, opts ...grpc.CallOption) (*WorkflowEnqueueResponses, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WorkflowEnqueueResponses)
...
type WorkflowServiceServer interface {
	...
	ExecuteWorkflow(context.Context, *WorkflowExecutionRequest) (*WorkflowEnqueueResponse, error)
	FindAndExecuteWorkflow(context.Context, *FindAndWorkflowExecutionRequest) (*WorkflowEnqueueResponses, error)
...
func (UnimplementedWorkflowServiceServer) GetWorkflowActivityPrompts(context.Context, *WorkflowActivityIdIntRequest) (*WorkflowActivityPrompts, error) {
...
func (UnimplementedWorkflowServiceServer) ExecuteWorkflow(context.Context, *WorkflowExecutionRequest) (*WorkflowEnqueueResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExecuteWorkflow not implemented")
}
func (UnimplementedWorkflowServiceServer) FindAndExecuteWorkflow(context.Context, *FindAndWorkflowExecutionRequest) (*WorkflowEnqueueResponses, error) {
...
func _WorkflowService_GetWorkflowActivityStorageSystems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServiceServer).GetWorkflowActivityStorageSystems(ctx, req.(*WorkflowActivityIdIntRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WorkflowService_GetWorkflowActivityPrompts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServiceServer).GetWorkflowActivityPrompts(ctx, req.(*WorkflowActivityIdIntRequest))
	}
	return interceptor(ctx, in, info, handler)
}
