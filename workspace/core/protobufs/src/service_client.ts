...
let clientInterceptor: Interceptor | undefined = undefined

export function setClientInterceptor(interceptor: Interceptor) {
...
export function useClient<T extends ServiceType>(service: T): PromiseClient<T> {
  ...
  const transport = newTransport(service.typeName, clientInterceptor)
  client = createPromiseClient(service, transport)
